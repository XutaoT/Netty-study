package com.xutao.netty.http.src.marshalling;
...
class SubReqClientHandler extends ChannelInboundHandlerAdapter {
    ...
    private com.xutao.netty.serializable.SubscribeReq subReq(int subReqID) {
        com.xutao.netty.serializable.SubscribeReq req = new SubscribeReq();
